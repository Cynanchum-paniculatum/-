...
# 读取数据
df = pd.read_csv('/Users/wzz/Desktop/pythonProject1/learner_finally.csv', encoding='ISO-8859-1')

# 相关性分析
df_tmp1 = df[['Location', 'QuadraticTerm', 'LinearTerm', 'DF', 'Endingpoint', 'Tvalue_min', 'Duration', 'Mean_F0', 'Length', 'HSKlevel', 'Gender', 'Assign']]
...
# 颜色列表
colors = [
    '#FCE38A', '#EAFFD0', '#95E1D3', '#F38181',
    '#dfc27d', '#fbb4b9', '#7fcdbb', '#377eb8',
    '#abdda4', '#d0d1e6', '#fbb4ae',
]
