...
# 读取数据
df = pd.read_csv('/Users/wzz/Desktop/pythonProject1/native_finally.csv', encoding='ISO-8859-1')

# 相关性分析
df_tmp1 = df[['Location', 'QuadraticTerm', 'LinearTerm', 'DF', 'Endingpoint', 'Tvalue_min', 'Duration', 'Mean_F0', 'musicaltraining','Gender', 'Assign']]
